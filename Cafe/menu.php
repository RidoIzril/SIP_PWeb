...
$query = mysqli_query($conn, "SELECT tb_daftar_menu.*, 
tb_kategori_menu.*,(tb_daftar_menu.stok-IFNULL(SUM(tb_list_order.jumlah), 0)) AS sisa_stok FROM tb_daftar_menu
LEFT JOIN tb_list_order ON tb_list_order.menu = tb_daftar_menu.id
